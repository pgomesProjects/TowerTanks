...
public class PlayerMovement : Character
{
    ...
    protected override void Update()
    {
        ...
        {
            currentFuel -= characterSettings.fuelDepletionRate * Time.deltaTime;
        ...
        else 
        {
            ...
            {
                currentFuel += characterSettings.fuelRegenerationRate * Time.deltaTime;
    ...
    {
        SetJetpackInput(ctx.ReadValue<float>() > 0);
        if (jetpackInputHeld && currentState != CharacterState.OPERATING) GameManager.Instance.AudioManager.Play("JetpackStartup", gameObject);
    }
