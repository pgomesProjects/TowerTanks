...
namespace TowerTanks.Scripts
{
    ...
    public class Room : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            else if (cells[0].backWall.TryGetComponent(out SpriteRenderer backWallRenderer))
        ...
        public bool Mount()
        {
            ...
            ChangeRoomColor(defaultRoomColor);                     //Change the room color to the default room color
            return mounted;
        }
        ...
        {
            //TODO: make a system that can disable room collision but still keep all of the connector checks intact
/*            foreach(Cell cell in cells) //Iterate through each cell in room
            {
