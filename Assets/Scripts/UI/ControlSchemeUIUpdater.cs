...
public class ControlSchemeUIUpdater : MonoBehaviour
{
    ...
    private UIPrompt[] CONTROLS =
    {
        ...
        new UIPrompt("Repair", KEYBOARD_TYPES[(int)KEYTYPE.RIGHT_CLICK], GAMEPAD_TYPES[(int)GAMEPADTYPE.BUTTON_NORTH]),
        new UIPrompt("Interact", KEYBOARD_TYPES[(int)KEYTYPE.E], GAMEPAD_TYPES[(int)GAMEPADTYPE.BUTTON_SOUTH]),
        new UIPrompt("Cancel", KEYBOARD_TYPES[(int)KEYTYPE.LEFT_CLICK], GAMEPAD_TYPES[(int)GAMEPADTYPE.BUTTON_EAST]),
        new UIPrompt("Build", KEYBOARD_TYPES[(int)KEYTYPE.SPACE], GAMEPAD_TYPES[(int)GAMEPADTYPE.BUTTON_WEST]),
