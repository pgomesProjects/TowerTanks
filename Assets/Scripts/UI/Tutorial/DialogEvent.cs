...
namespace TowerTanks.Scripts.Deprecated
{
    ...
    abstract public class DialogEvent : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("The lines of dialog shown in order.")]
        ...
        [SerializeField]
        [Tooltip("The object that holds the message text.")]
        protected TextMeshProUGUI messageText;
        [SerializeField]
        [Tooltip("The object that holds whatever will be used to tell the player to continue the dialog.")]
